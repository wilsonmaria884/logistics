...
<head>
	<title>Flight Booking &#8211; Military</title>
...
<li id="menu-item-24" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-24"><a href="soldier.php">Soldier ID</a></li>
					...
					<div class="top_panel_title_inner top_panel_inner_style_3  title_present_inner breadcrumbs_present_inner">
						<div class="content_wrap">
															<h3 class="page_title">Flight Booking</h3>
																						<div class="breadcrumbs">
									<a class="breadcrumbs_item home" href="/">Home</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Flight Booking</span>								</div>
													</div>
					</div>
				</div>
...
<div class="content">        
  ...
  <div class="container">
    <h4 class="display-4">Booker's Information</h4>
   
  </div>
</div>
	
<div id="sc_contact_form_1355519955" class="sc_contact_form sc_contact_form_standard  " style="width:100%;">

	<form  data-formtype="contact" method="post" action="" class="inited"><div class="sc_contact_form_info">
	
	<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Full Name</label><input id="sc_contact_form_username" type="text" name="bfullname" placeholder="Enter Full Name"></div>
	
	<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Phone</label><input id="sc_contact_form_username" type="text" required name="bphone" placeholder="Enter Phone Number"></div>
	<div class="sc_contact_form_item sc_contact_form_field form_field_email label_over"><label class="required" for="sc_contact_form_email">E-mail</label><input id="sc_contact_form_email" type="text" required name="bemail" placeholder="Enter Your Email *"></div>

	</div>
	
	<hr/>
	<h4 class="display-4">Soldier's Information</h4>
	<hr/>
<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Full Name</label><input id="sc_contact_form_username" type="text" required name="sfullname" placeholder="Full Name"></div>
	
	<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Soldier ID Number</label><input id="sc_contact_form_username" required type="text" name="sid" placeholder="Soldier ID Number"></div>
<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Email</label><input id="sc_contact_form_username" type="email" required name="semail" placeholder="Soldier's Email"></div>
	
	<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Current State</label><input id="sc_contact_form_username" required type="text" name="scurrents" placeholder="Current State"></div>
		
	<div class="sc_contact_form_item sc_contact_form_field form_field_email label_over"><label class="required" for="sc_contact_form_email">Country:</label>
		<select id="sc_contact_form_email" required name="scurrentc">
	...
	<hr/>
	<h4 class="display-4">Transit Details</h4>
	<hr/>
	<div class="sc_contact_form_item sc_contact_form_field form_field_email label_over"><label class="required" for="sc_contact_form_email">Transit Type:</label>
		<select id="sc_contact_form_email" required name="ttype">
                     <option value="">-- Select Type of Transit --</option>
                                <option value="One way Trip">One Way Trip</option>
                                <option value="Round Trip">Round Trip</option>
                                

		</select> </div>
	<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Leaving From:</label><input id="sc_contact_form_username" required type="text" name="leavef" placeholder="Enter State and Country"></div>
	<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Going To:</label><input id="sc_contact_form_username" required type="text" name="goingt" placeholder="Enter State and Country"></div>
	
	<div class="sc_contact_form_item sc_contact_form_field form_field_name label_over"><label class="required" for="sc_contact_form_username">Date Of Departure:</label><input id="sc_contact_form_username" required type="text" name="dod" placeholder="Enter Date of Departure"></div>
	
	<div class="sc_contact_form_item sc_contact_form_field form_field_email label_over"><label class="required" for="sc_contact_form_email">Flight Class:</label>
		<select id="sc_contact_form_email" required name="firstc">
	...
	<div class="sc_contact_form_item sc_contact_form_field form_field_email label_over"><label class="required" for="sc_contact_form_email">Adult:</label>
		<select id="sc_contact_form_email" required name="adult">
	...
	<div class="sc_contact_form_item sc_contact_form_field form_field_email label_over"><label class="required" for="sc_contact_form_email">Children:</label>
		<select id="sc_contact_form_email" required name="children">
	...
	<div class="sc_form_field sc_form_field_checkbox">
                  ...
                  <label for="i_agree_privacy_policy_sc_form_1">I agree that my submitted data is being collected and stored.</label></div><div class="sc_contact_form_item sc_contact_form_button"><input class="sc_button_size_large" type="submit" name="apply" value="BOOK NOW "></div><div class="result sc_infobox"></div></form></div>
