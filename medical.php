...
<head>
	<title>Medical Care &#8211; Military</title>
...
<!--[if lte IE 9]><link rel="stylesheet" type="text/css" href="http://military.ancorathemes.com/wp-content/plugins/js_composer/assets/css/vc_lte_ie9.min.css" media="screen"><![endif]--><meta name="generator" content="Powered by Slider Revolution 5.4.8.3 - responsive, Mobile-Friendly Slider Plugin for WordPress with comfortable drag and drop interface.">
					...
					<div class="columns_wrap columns_fluid"><div class="column-1_3 contact_logo">
						...
						<a href="index.html"><img src="wp-content\uploads\2015\07\logo.png" class="logo_main" alt="img"><img src="wp-content\uploads\2015\07\logo.png" class="logo_fixed" alt="img"></a>
							...
							<nav role="navigation" class="menu_main_nav_area">
								...
								<li id="menu-item-723" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-723"><a href="index.html">Home</a>
...
<li id="menu-item-24" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-24"><a href="soldier.php">Soldier ID</a></li>
					...
					<div class="top_panel_title_inner top_panel_inner_style_3  title_present_inner breadcrumbs_present_inner">
						<div class="content_wrap">
															<h3 class="page_title">Medical</h3>
																						<div class="breadcrumbs">
									<a class="breadcrumbs_item home" href="/">Home</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Medical Kit</span>								</div>
													</div>
					</div>
				</div>
	
<img src="wp-content/uploads/2015/07/mk.jpg"/>
...
<div class="content">        
  ...
  <div class="container">
    <h1 class="display-4">Medical Kits</h1>
    <p class="lead">Request for a Medical Kit online.
.</p>
  </div>
</div>
	
	<p style="line-height: 200%;text-align: justify;text-justify: inter-word;">
                <b>Mini Medical Kit Combo – $1500.00 USD </b><br>

                Tactical Rip-Away EMT Pouch with 84 Piece Improved First Aid Kit (IFAK)

                The Military IFAK Level 1 First Aid Kit pouch features a “Rip-Away” capability which allows a soldier to quickly transfer the gear to another soldier in an emergency situation without the need to unfasten the Molle straps. The pouch has a trifold design with various inner pouches and pockets, this allows the kits 84 items to be neatly organized and secured.<br>

                <b>Contents:</b><br>
                Pouch 1 – Condor Brand Rip-Away EMT Pouch #MA41,
                Disinfectants 1 – Bar of Soap (1/2 oz), 8 – Alcohol Pads, 4 – Iodine Pads ,4 – BZK Wipes,
                Medicine 4 – Aspirin Tablets ,4 – Non-Aspirin Tablets, 2 – Ibuprofen Tablets, 1 – Ammonia Inhalant ( Smelling Salts), 1 – Pill Bottle
                Wound Care 2 – Bacitracin, 2 – Triple Antibiotic Ointment, 1 – Instant Ice Pack
                Bandages 18 – Sheer Bandages 1″ x 3″ , 12 – Fabric Bandages 1″ x 3″ , 1 – Large Triangle Bandage 40″ x 40″ x 56″
                2 – Elastic Bandages 2″
                Gauze 2 – Sterile Gauze Pad 12ply 4″ x 4″ , 4 – Sterile Gauze Pad 12ply 3″ x 3″ , 3 – Combine Gauze Pad (ABD) 12ply 5″ x 9″
                Gauze Rolls 1 – Gauze Bandage Roll 4″ x 4.1yds, 1 – Gauze Bandage Roll 2″ x 4.1yds
                MISC 2 – Surgical Paper Tape 1/2″ x 10yds, 1 – EMT Shears 5″, 1 – Tourniquet 1″ x 18″, 1 – Pair of Nitrile Surgical Gloves (Non-Latex) Best Quality. <br><a href="soldier.php">
		<input type="button" name="" value="Order Now" onclick="orders()"></a>
                <br><br>

                <b>Flex Maxi Medical Kit Combo – $2700.00 USD</b> <br>
                This GI style issued kit folds out three ways for easy and quick access to all your first aid supplies. <br>
                <b>Contents:</b><br>
                1 Blood Pressure Cuff Kit, 1 Cervical Collar, 1 Pen Light, 2 Suture Sets, 8 Latex Examination Gloves (pair), 10 Abdominal Pads 5″ x 9″, 20 Pain Relievers, 6 Safety Pins, 2 Emergency Blankets – 52″ x 84″ Silver, 1 Hand Sanitizer – 2 Oz, 1 Calamine Lotion – 6 Oz, 1 Hand Soap, 6 After Bite Wipes, 1 SAM/Universal Splint, 1 Elastic Bandage – 6″, 5 Sterile Sponges – 4″ x 4″, 2 Adhesive Tape Rolls, 2 Bleedstop Bandages, 5 Eye Pads, 2 Triangular, Bandages – 40″ x 40″ x 56″, 1 Tourniquet, 16 Bandage Strips – 1″ x 3″, 5 Butterfly Strips, 5 Bandage Strips – 2″ x 3″, 10 Knuckle Bandages
                2 Instant Ice Pack, 1 EMT Shears, 2 Stainless Steel Hempstead, 1 Tweezers, 1 Scalpel Handle #3, 2 Scalpel Blades, 1 Stethoscope, 5 Tongue Depressors , 1 CPR Mask, 45 Antiseptic BZK Wipes, 5 Ammonia Inhalants, 2 Airways, 3 Multi Trauma Dressings – 12″ x 30″, 1 Skin and Eye Wash, 10 Triple Antibiotic Packages, 5 Burn Aid Packages, 1 EFA First Aid Book <br><a href="soldier.php">
		<input type="button" name="" value="Order Now" onclick="orders()"></a>
                <br><br>

                <b>King Medical Kit Combo – $3600.00 USD </b><br>

                First Aid Kit Large M17 Medic Bag. Used by combat trained medics. Comes in an OD green XL nylon pack (measuring approximately 13″ x 13″ x 10″) with hand carry straps. Closes securely using four adjustable chinch straps. The bag rolls open to reveal its contents contained within one of its six individual interior pockets inside its three-fold design. There is also one exterior pocket that is secured by a Velcro flap. Contains over 300 items including an assortment of bandages, wraps, ointments, medicine, ice packs, syringes, latex gloves, safety pins, pill bottles, tape, cotton tips, hemostats, sponges, airways, wipes, inhalants and suture sets. Kit also includes a CPR mask, tongue depressor, thermometer, first aid book, arm splint, blood stopper kit, pen light, EMT shears, tweezers, skin probe and scalpel. Excellent kit for home, office or vehicle. Weighs 15 lbs. Contents may vary slightly.<br>

                <b>Contents:</b><br> 1 EFA First Aid Book, 20 Pill Bottles, 100 Bandage Strips, 1″x3″, 14 Pain Relievers, 10 Bandage Strips, 2″x4″, 4 Triple Antibiotic Packages, 10 Knuckle Bandages, 4 First Aid Cream Packages, 10 Butterfly Strips, 2 Burn Aid Packages, 4 Bandage Gauzes, 2″x6 Yards, 1 SAM/Universal Splint, 4 Elastic Bandages, 6″, 1 EMT Shears, 7.25″, 2 Triangular Bandage, 1 Pair of Tweezers, 3 Field Dressings, 1 Stethoscope, 4 Multi Trauma Dressings 12″x30″, 1 Tourniquet, 1 Blood Stopper Kit, 1 Scalpel handle #3, 4 Sterile Pads, 4″x4″, 2 Scalpel Baldes
                10 Sterile Pads, 2″x2″, 1 Skin Probe, 10 Abdominal Pads, 5″x9″, 2 Stainless Steel homestat, 2 Eye Pads, 1 Pen Light, 15 Alcohol Wipes, 2 Suture Sets
                15 Iodine Wipes, 5 Tape, Rolls, Adhesive, 1″, 15 Antiseptic BZK Wipes
                2 Tongue Depressors , 15 Clean Wipes
                2 Airways, 6 After Bite Wipes, 2 Ammonia Inhalants, 1 Burn Spray, 1 CPR Mask, 1 Petroleum jelly, 2 Irrigation Syringes, 1 Lip Treatment
                3 Instant Ice Packs, 1 Calamine Lotion, 6 oz., 6 Safety Pins, 1 Sterile Flushing Solution, 1 Box of Sponges, 4″ x4″, 1 Hand Sanitizer, 1 Box of 100 Cotton Tips, 1 Hand Soap, 6 Pairs Latex Examination Gloves<br><a href="soldier.php">
		<input type="button" name="" value="Order Now" onclick="orders()"></a>
...
<script type='text/javascript'>
/* <![CDATA[ */
var TRX_DEMO_STORAGE = {"ajax_url":"http:\/\/military.ancorathemes.com\/wp-admin\/admin-ajax.php","ajax_nonce":"2e30c575c6","site_url":"http:\/\/military.ancorathemes.com","user_logged_in":"0","msg_ajax_error":"Invalid server response! Try again later.","tabs_delay":"5000"};
/* ]]> */
</script>
...
<script type='text/javascript'>
/* <![CDATA[ */
var wpgdprcData = {"ajaxURL":"http:\/\/military.ancorathemes.com\/wp-admin\/admin-ajax.php","ajaxSecurity":"527e7bd6da","consentVersion":"1","consentStatus":"0","isMultisite":"","path":"\/","blogId":""};
/* ]]> */
</script>
