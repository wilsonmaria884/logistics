...
<head>
	<title>Care Pack &#8211; Military</title>
...
<li id="menu-item-24" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-24"><a href="soldier.php">Soldier ID</a></li>
					...
					<div class="top_panel_title_inner top_panel_inner_style_3  title_present_inner breadcrumbs_present_inner">
						<div class="content_wrap">
															<h3 class="page_title">Care Packs</h3>
																						<div class="breadcrumbs">
									<a class="breadcrumbs_item home" href="/">Home</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">Care Pack</span>								</div>
													</div>
					</div>
				</div>
	
<img src="wp-content/uploads/2015/07/cp.jpg"/>
...
<div class="content">        
  ...
  <div class="container">
    <h1 class="display-4">Care Pack</h1>
	...
	<p style="line-height: 200%;text-align: justify;text-justify: inter-word;">
                ...
                1. <b>Troops Pass Time Package - $1200.00 Includes:</b>
                <br>Sweaters, Pack of underwears, Cotton Socks, Vitamins, Pack of Aspirin, pain Reliever, Toothbrush, Toothpaste, Shaving lotion, Laundry Detergent, Lip balm, Deodorant, Body spray, Hand warmer, T-shirts, Snack Cakes, Cheese Crackers, Cookies, Energy Bars.<br><a href="soldier.php"><input type="button" name="" value="Buy Now" onclick="orders()"></a>

                <br><br>

                2. <b>Troops Combo Package - $2080.00 Includes:</b>
                <br>Sweaters, Pack of underwears, Cotton Socks, Vitamins, Pack of Aspirin, Medicated foot powder, Shampoo, Kleenex, Laundry detergent, Tootbrush, Dental Floss, Shaving Lotion, Lip balm, Hand warmer, T-shirts, Crossed Puzzles, MP3 Player/CDs, Snacks Cakes, Cheese Crackers, Cookies, Energy Bars. <br><a href="soldier.php"><input type="button" name="" value="Buy Now" onclick="orders()"></a>

                <br><br>

                3. <b>Troops Home Size Package - $3670.00 Includes:</b>
                <br> Sweater, Pack of underwear, T-shirts, Fingerless gloves, Stocking cap, Instant Coffee, Tea bags, Snack Cakes, Cheese Crackers, Electrolyte replacements, Tuna Fish, Sardines, Shaving lotion, Shampoo, Kleenex, Laundry detergent, Body spray (Gillete, etc) Lotion, Lip balm, Hand warmer, Vitamins, Pack of Aspirin, Canned Foods (mix) Crossed Puzzles, MP3 Players/CD.<br><a href="soldier.php"><input type="button" name="" value="Buy Now" onclick="orders()"></a>

                <br><br>

                4. <b>Troops All In One Package - $6750.00 Includes:</b>
                <br>Canned Foods (All Mixed), Electrolyte replacement mix, Beverages, Instant Coffee, Tea bags, Creamer, Ketchup, Energy Bars, Tuna Fish, Sardines, Corn Beef, Snack Cakes, Cheese Crackers, Cookies, Toothbrush, Tootpaste, Mouthwash, Dental floss, Cotton Swabs, Shaving Lotion, Disposable razors, Kleenex, Shampo, Laundry detergent, Eye drops, Lip balm, Lotion, Deodorant/Body Spay, Pack of Aspirin or other pain reliever, medicated foot powder, Athlete’s Foot ointment, Underwears, T-shirts, Hand warmers, Goggle-style sunglasses, Cotton socks, Fingerless Gloves, Stocking caps, MP3 Players/CD with batteries, Magazines, Crossed Puzzles.<br><a href="soldier.php"><input type="button" name="" value="Buy Now" onclick="orders()"></a>
